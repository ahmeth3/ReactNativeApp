...
export default class InitialProfessor extends Component {
  ...
  fetchSubject(grade) {
    ...
    if (department == '' || profile == '') {
      ...
      axios
        .post(
          `https://blooming-castle-17380.herokuapp.com/subject/fetchByCriteriaProfessor/${this.props.jwt}`,
          {
  ...
  updateSubjects(grade) {
    axios
      .patch(
        `https://blooming-castle-17380.herokuapp.com/professor/update-subjects/${this.props.jwt}`,

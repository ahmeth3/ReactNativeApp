...
export default class EditStudentSubjects extends Component {
  ...
  fetchSubject(grade) {
    axios
      .post(
        `https://blooming-castle-17380.herokuapp.com/subject/fetchByCriteriaStudent/${this.jwt}`,
        { grade: grade }
      )
      .then((response) => {
        this.setState({
  ...
  updateSubjects(grade) {
    axios
      .patch(
        `https://blooming-castle-17380.herokuapp.com/student/update-subjects/${this.jwt}`,
